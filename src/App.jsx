      ...
      {tab === 'meal' && <section className="panel">
        ...
        <details className="edit-box" id="meal-edit">
          ...
          <div className="form-grid">
            ...
            <label>ウリ 共通おかずg<input value={mealConfig.uriHotcookNote || ''} onChange={e=>setMealConfig({...mealConfig, uriHotcookNote:e.target.value})} /></label>
            <label>ルル 共通おかずg<input value={mealConfig.luluHotcookNote || ''} onChange={e=>setMealConfig({...mealConfig, luluHotcookNote:e.target.value})} /></label>
          </div>
